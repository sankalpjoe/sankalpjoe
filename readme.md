...
<sub>Public repository data last synced: 24 September 2026 at 20:29 UTC. <a href="https://github.com/sankalpjoe?tab=repositories">See the live repository list</a>.</sub>

## Selected work

From quantum experiments to tools you can use. Open a panel to explore its repository.

<a href="https://github.com/sankalpjoe/PQC">
<picture>
  <source media="(max-width: 600px)" srcset="assets/project-PQC-mobile.svg">
  <img src="assets/project-PQC.svg" width="100%" alt="Post-quantum laboratory — A Python research suite for lattice, code-based, multivariate and hybrid cryptography, with a shared provider interface.">
</picture>
</a>
...
These panels follow the public repository list automatically. Empty and archived repositories are labelled.
...
<a href="https://github.com/sankalpjoe/billyzer">
<picture>
  <source media="(max-width: 600px)" srcset="assets/project-billyzer-mobile.svg">
  <img src="assets/project-billyzer.svg" width="100%" alt="billyzer — No public files yet. This card will update when content is pushed.">
</picture>
</a>

<a href="https://github.com/sankalpjoe/QCBM-Options-Pricing">
<picture>
  <source media="(max-width: 600px)" srcset="assets/project-QCBM-Options-Pricing-mobile.svg">
  <img src="assets/project-QCBM-Options-Pricing.svg" width="100%" alt="QCBM-Options-Pricing — Pricing Options using Synthetic Data generated by Quantum techniques">
</picture>
</a>
...
<sub>Public GitHub snapshot: 24 September 2026 at 20:29 UTC. [View source data](data/public-repos.json) · [Refresh workflow](https://github.com/sankalpjoe/sankalpjoe/actions/workflows/refresh-profile.yml). Project illustrations are conceptual; counts and language shares come from GitHub.</sub>
